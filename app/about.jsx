            ...
            <div className="lists">
                <div className="list">
                    <p className="text_common">Смысл в том, что когда ты пишешь слово, например:</p>
                      <div className="text-wrapper">п<span className="black-relative">о</span><span className="black-relative">э</span>з<span className="black-relative">и</span><span className="black-relative">я</span></div>
                      ...
                      <div className="text-wrapper">п<span className="black-relative">о</span><span className="red-relative">э</span>з<span className="black-relative">и</span><span className="black-relative">я</span></div>
