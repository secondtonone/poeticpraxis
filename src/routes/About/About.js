...
export default class About extends Component {
    ...
    render({ lang = 'ru' }) {
        ...
        let text = `Духовной жаждою томим,\nВ пустыне мрачной я влачился,\nИ шестикрылый серафим\nНа перепутье мне явился...`;

        let stringsDictionary = JSON.parse(
        ...
        return (
            <List _animated>
                ...
                <Text isHidden={!isRusLang}>
                    ...
                    любого набора слов, составлять случайные пары, получая
                    неожиданные образы. Для лучшего результата, нужно
                    использовать существиетльные и приглагательные. Вообще можно
                    использовать всё кроме глаголов, но если вы хотите
                    использовать и их, то никто мешать конечно же не будет. Что
                    если попробовать получить новые сочетания не из простого
                    набора слов, а из подготовленного материала: случайной
                    статьи, переписки, отрывка из книги, а может даже из
                ...
                <Text isHidden={isRusLang}>
                    New technologies give us new possibilities and instruments.
                    "Images engine", created by russian poet{' '}
                    <Link href="https://en.wikipedia.org/wiki/Sergei_Yesenin">
                        S.A. Yesenin
                    </Link>{' '}
                    , make from any words random pairs. It gives us intresting
                    images. For best result better use noun and adjective. You
                    can try not only words. You can do it with random texts,
                    articles, excerpts from books, poems or with your friends.
                    Without paper and scissors.
                </Text>
                <Text isHidden={!isRusLang}>
                ...
                <Text isHidden={isRusLang}>
                    ...
                    <Link href="/images-engine">IMAGES ENGINE</Link> and push
                    {' '}
                    <Button _rounded _transparent type="button">
                        <Widgets _small />
                    </Button>
                    button. After, you see pairs of words. You can add intresting
                    pairs to favorites. You can try again get another pairs, but
                    pairs in favorites will be stayed.
                </Text>
                <Text isHidden={!isRusLang}>
                ...
                <Text isHidden={isRusLang}>
                    ...
                    <Link href="/rhythmic">RHYTHMICS</Link>, by{' '}
                    <Button _flat _transparent type="button">
                ...
                <Text isHidden={!isRusLang}>
                    Ритм стихотворения - немаловажный аспект. Но ритм существует
                    не только в стихах, его можно встретить и в ритмической
                    прозе. На странице <Link href="/rhythmic">РИТМИКА</Link>{' '}
                ...
                <Text isHidden={isRusLang}>
                    ...
                    <Link href="/rhythmic">RHYTHMICS</Link> you can research
                    text. Editor marks syllables, but researcher marks stressed
                    syllables yourself by clicking on letters. Try to continue
                    it below:
                </Text>
                <Text.Wrapper>
                    <Workfield
                ...
                <Text isHidden={isRusLang}>
                    Editor memorizes stressed syllables but only on one device.
                    In known words it will be marking syllables itself. You can
                    make pause or caesura by{' '}
                    <Button _rounded _transparent type="button">
                        <KeyboardCapslock _small />
                    </Button>{' '}
                    button.
                ...
                <Text isHidden={isRusLang}>
                    Ready rhythmic picture can be copied to text editors (Google
                    Docs, MS Word and etc.) by{' '}
                    <Button _rounded _transparent type="button">
                        <ContentCopy _small />
                    </Button>
                    button.
                ...
                <Text isHidden={isRusLang}>
                    It doesn't do all the work for you. It is just instrument in
                    your researching, for your creation.
                </Text>
                <Text.Title>
                ...
                <Text isHidden={isRusLang}>
                    Sometimes, instruments are getting new features, that give new opportunities. Just go research and create!
                </Text>
                <Footer>
