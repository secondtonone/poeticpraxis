    ...
    render() {
        ...
        return (<div >
            <arcticle className="list list--animated list-about">
               ...
               <p className="text_common">Новые технологии дарят нам и новые возможности. <a className="menu__item_active" href="/images-engine">МАШИНА ОБРАЗОВ</a> (когда-то изобретённая С. А. Есениным) позволяет из любого набора слов составлять случайные пары, получая неожиданные образы. Здесь она претерпела изменения. Что если попробовать получить новые сочетания не из простого набора слов, а какого-нибудь интересного текста, а может даже из стихотворения? А из нескольких? Вам стоит узнать, что из этого выйдет. Быстро и сколько угодно.</p>
