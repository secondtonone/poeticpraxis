...
import { Link, TextAccent, Strong, TextMinor } from '@styles/components';

interface AboutEngineProps {
    mediaQuery: boolean;
    lang: Langs;
}

const AboutEngine: FunctionalComponent<AboutEngineProps> = ({
  lang = 'ru',
  mediaQuery,
}) => {
          ...
          <Container
            ...
            <Text isHidden={!isRusLang}>
              ...
              <TextMinor>(1)</TextMinor>, составлять случайные
                            ...
                            образы<TextMinor>(3)</TextMinor>. А образы очень
                            важны для стихов.
            </Text>
            <Text isHidden={isRusLang}>
