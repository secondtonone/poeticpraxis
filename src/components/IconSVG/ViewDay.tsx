    ...
    return (
        <Icon {...props}>
            <svg
                ...
                <g id="Rounded" display="none">
                    ...
                    <path
                        display="inline"
                        d="M4,19h16c0.55,0,1-0.45,1-1v-4c0-0.55-0.45-1-1-1H4c-0.55,0-1,0.45-1,1v4C3,18.55,3.45,19,4,19z M4,11h16
		...
		c0.55,0,1-0.45,1-1v0c0-0.55-0.45-1-1-1H4C3.45,5,3,5.45,3,6z"
                ...
                <g id="Sharp" display="none">
                    ...
                    <path
                        display="inline"
                        d="M3,19h18v-6H3V19z M3,11h18V9H3V11z M3,5v2h18V5H3z"
                    />
                </g>
                <g id="Outline">
